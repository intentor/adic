...
namespace Adic {
	...
	/// 
	/// The idea of this cache is to reduce the execution of
	/// reflection by caching data about types.
	/// 
	/// The cache should always look for constructors
	...
	public interface IReflectionCache {
		...
		IReflectedClass this[Type key] { get; }
		...
		IReflectedClass GetClass(Type type);
